        ...
        <div className="accordion" id="accordionExample">
            ...
            >
              <div className="accordion-body">
                <strong>
                  ...
                  efficently.It let you to count word, count charecters or
          ...
          >
            ...
            >
              <div className="accordion-body">
                <strong>
                  TextUtils is a free charecter counter tool that provided
                  instant charecter count and word count statics for a given
                  text. TextUtils reports the number of words and charecter.
                  Thus it is suitable for writing text with word / charecter
                  limit.
                </strong>
              </div>
            </div>
